        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {calls.map((call) => {
            ...
            return (
              <div
                key={call.id}
                className="bg-white rounded-xl shadow-lg border-2 border-green-200 p-6 hover:shadow-2xl transition-all transform hover:-translate-y-1"
              >
                {/* Stock Name & Pattern */}
                ...
                {/* Entry Price */}
                <div className="mb-3">
                  <p className="text-sm text-gray-600">Entry Price (LTP)</p>
